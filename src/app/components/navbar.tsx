...
// import Image from 'next/image' // Uncomment if you plan to use it in the future
    ...
    <div className='bg-white z-50 stick top-0'>
      <header className="text-gray-600 body-font">
        <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
          <span className="ml-3 text-xl flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            Shumi&apos;s Tec Zone
          </span>
